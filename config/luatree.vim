...
function! NvimTreeHi()
highlight NvimTreeSymlink                       guifg=LightGray guibg=LightGray
highlight NvimTreeFolderIcon                    guifg=LightGray guibg=LightGray
highlight NvimTreeFolderName           gui=NONE guifg=#52aeef
highlight nvimtreerootfolder           gui=NONE guifg=#ff99bf
highlight NvimTreeEmptyFolderName      gui=NONE guifg=#52aeef
highlight NvimTreeOpenedFolderName     gui=NONE guifg=#52aeef
