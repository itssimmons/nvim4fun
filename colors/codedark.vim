...
call <sid>hi('GitSignsAddLn', s:cdRed, {}, 'none', {})
call <sid>hi('GitSignsChangeLn', s:cdPink, {}, 'none', {})
call <sid>hi('GitSignsDeleteLn', s:cdGray, {}, 'none', {})

"lua << EOF
   "GitSignsAdd = { '#008000', nil, 'none', nil},
   "GitSignsChange = { '#795E26', nil, 'none', nil},
   "GitSignsDelete = { '#FF0000', nil, 'none', nil},
   "GitSignsAddLn = { '#1E1E1E', '#008000', 'none', nil},
   "GitSignsChangeLn = { '#1E1E1E', '#795E26', 'none', nil},
   "GitSignsDeleteLn = { '#1E1E1E', '#FF0000', 'none', nil},
"EOF
